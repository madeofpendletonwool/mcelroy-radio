...
import (
	...
	"github.com/madeofpendletonwool/mcelroy-radio/internal/server"
)
...
func main() {
	...
	go func() {
		fmt.Printf("McElroy Radio is broadcasting on http://localhost:%s\n", cfg.Port)
	...
	log.Println("McElroy Radio has gone off air. Sweet dreams!")
}
